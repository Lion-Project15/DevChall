...
public class NotProd {
    ...
    CommandLineRunner initData(
        ...
        return args -> {
            ...
            challengePostService.write("1-1인증", "1-1인증 내용입니다.", true, 1);
            challengePostService.write("1-2인증", "1-2인증 내용입니다.", false, 1);
            challengePostService.write("2-1인증", "2-1인증 내용입니다.", true, 2);
            challengePostService.write("2-2인증", "2-2인증 내용입니다.", false, 2);
            challengePostService.write("3-1인증", "3-1인증 내용입니다.", true, 3);
            challengePostService.write("3-2인증", "3-2인증 내용입니다.", true, 3);
